...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ma772528138@qq.com/MAPreviewController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ma772528138@qq.com' => 'ma772528138@qq.com' }
  s.source           = { :git => 'https://github.com/ma772528138@qq.com/MAPreviewController.git', :tag => s.version.to_s }
